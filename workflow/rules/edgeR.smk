...
rule run_edgeR:
  input: expand(results_dir+"/rrbs_samples/methylation_calls/samples/methylKit_{sample}.{repeats}_{context}.detrack.gz", sample=set_options['rrbs_samples'], repeats=repeats, context='CpG')
